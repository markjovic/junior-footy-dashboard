...
const CUR = path.join(ORGS, '383836bb-current.json');
...
function write(opts) {
  ...
  // The ARCHIVE carries pre-2026-08-12 gradeMeta: rawGrade keys, no label, no id.
  ...
  fs.writeFileSync(CUR, JSON.stringify({
