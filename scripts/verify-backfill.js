...
//
// ⚠️ THE CURRENT SEASON'S DATES ARE RELATIVE TO TODAY, NOT HARD-CODED.
//
...
'use strict';
// THE CURRENT SEASON'S MONTHS ARE RELATIVE TO TODAY. See the note in the suite
// above the stub for why. String concatenation, not a template literal: this code
// lives inside the template that writes the stub file.
var _n = new Date();
